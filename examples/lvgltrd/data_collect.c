...
/**
 * @brief initialize thread for data collection
 * this function initializes a thread for collecting data. the thread handle is created on the stack and not stored.
 * No chance to kill this thread via handle.
 * @param[in] autob_dat data of auto boiler including e.g. probe and environment temperature
 * @return none
 */
